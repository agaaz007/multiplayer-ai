...
const validatorSource=fs.readFileSync(new URL('./review-validator-v3.mjs',import.meta.url),'utf8');
...
export function preflight(configFile) {
  ...
  if(cfg.schema!=='pm-review-run/v3'||cfg.execution_authorized!==true||!cfg.authorization)throw new Error('explicit authorized pm-review-run/v3 configuration required');
